...
function getConfigs(){
	...
	$.ajax({
        ...
        success: function(data){
        	...
        	document.getElementById("MinimumInsurMonths").value=data.split(":")[0];
        	document.getElementById("MaximumInsurMonths").value=data.split(":")[1];
        	document.getElementById("MinCoverage").value=data.split(":")[2];
        	document.getElementById("MaxCoverage").value=data.split(":")[3];
        	document.getElementById("MinInstMonths").value=data.split(":")[4];
        	document.getElementById("MaxInstMonths").value=data.split(":")[5];
        	document.getElementById("InstallmentInterest").value=data.split(":")[10];
        }
});
}
