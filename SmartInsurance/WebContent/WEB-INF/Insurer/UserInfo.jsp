                            ...
                            <div class="card-body">
                                ...
                                <div class="all-user-box">
                                    <div class="media media-none--xs active">
                                        <div class="item-img">
                                            <img src="img2/figure/user1.jpg" class="media-img-auto" alt="user">
                                        </div>
                                        <div class="media-body space-md">
                                            <h5 class="item-title">Steven Johnson</h5>
                                            <div class="item-subtitle">lorem ipsum</div>
                                        </div>
                                    </div>
                                    <div class="media media-none--xs">
                                        <div class="item-img">
                                            <img src="img2/figure/user2.jpg" class="media-img-auto" alt="user">
                                        </div>
                                        <div class="media-body space-md">
                                    ...
                                    <div class="media media-none--xs">
                                        <div class="item-img">
                                            <img src="img2/figure/user3.jpg" class="media-img-auto" alt="user">
                                        </div>
                                        <div class="media-body space-md">
                                    ...
                                    <div class="media media-none--xs">
                                        <div class="item-img">
                                            <img src="img2/figure/user4.jpg" class="media-img-auto" alt="user">
                                        </div>
                                        <div class="media-body space-md">
                                    ...
                                    <div class="media media-none--xs">
                                        <div class="item-img">
                                            <img src="img2/figure/user5.jpg" class="media-img-auto" alt="user">
                                        </div>
                                        <div class="media-body space-md">
                        ...
                        <div class="card account-settings-box">
                            <div class="card-body">
                                ...
                                <div class="user-details-box">
                                    <div class="item-img">
                                        <img src="img2/figure/user.jpg" alt="user">
                                    </div>
                                        ...
                                        <div class="info-table table-responsive">
                                            <table class="table text-nowrap">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>ID no:</td>
                                                        <td class="font-medium text-dark-medium">2201</td>
                                                    </tr>
                                                    <tr>
                                                        <td>Gender:</td>
                                                    ...
                                                    <tr>
                                                        <td>Insured item:</td>
                                                        <td class="font-medium text-dark-medium">car</td>
                                                    </tr>

                                                    <tr>
                                                        <td>Payment type:</td>
                                                        <td class="font-medium text-dark-medium">cash</td>
                                                    </tr>
                                                    <tr>
                                                        <td>Address:</td>
