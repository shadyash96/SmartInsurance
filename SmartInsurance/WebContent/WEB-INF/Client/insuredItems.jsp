    		...
    		<div class="col-lg-3 col-md-3 sidebar-left">
    			<div class="widget member-card">
    				...
    				<jsp:include page="clientSideMenu.jsp">
    				 <jsp:param name="active" value="insuredItems"/>
    				</jsp:include>
		...
		<%for (int i=0;i<InsuredItems.size();i++){ %>
    			  <tr>			
    				<td class="property-title">
    					<a href="property-single.html"><%=InsuredItems.get(i)[1] %></a><br/>
    					<p class="category"><i class="fa fa-arrow-right icon"></i><%=InsuredItems.get(i)[0] %></p>
    					<p ><strong>EGP <%=InsuredItems.get(i)[2] %></strong></p>
    				</td>
    				<td class=""><%=InsuredItems.get(i)[4]%>%</td>	
    				<td class="" ><%=InsuredItems.get(i)[5]%></td>
    				<td class="property-date"><%=InsuredItems.get(i)[6]%></td>
    				<td class="property-post-status" style="padding-left:30px;"><span class="button small alt" style="<%=(InsuredItems.get(i)[7].equals("Expired")?"background-color: red;":"")%>"><%=InsuredItems.get(i)[7] %></span></td>
